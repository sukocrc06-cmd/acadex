...
(function () {
  ...
  const THEMES = {
    ...
    ocean: {
      ...
      border: '#bae6fd',
      canvasBg: '#f0f9ff',
      heroGrad: 'linear-gradient(145deg,#0369a1 0%,#0c4a6e 100%)',
      pptx: { accent: '0284C7', navy: '0C4A6E', text: '0F172A', soft: 'E0F2FE', border: 'BAE6FD' }
    },
    violet: {
      id: 'violet',
      label: 'Violet',
      ...
      border: '#ddd6fe',
      canvasBg: '#f5f3ff',
      heroGrad: 'linear-gradient(145deg,#6d28d9 0%,#4c1d95 100%)',
      pptx: { accent: '7C3AED', navy: '4C1D95', text: '1E1B4B', soft: 'EDE9FE', border: 'DDD6FE' }
    },
    rose: {
      id: 'rose',
      label: 'Rose',
      ...
      border: '#fecdd3',
      canvasBg: '#fff1f2',
      heroGrad: 'linear-gradient(145deg,#be123c 0%,#881337 100%)',
      pptx: { accent: 'E11D48', navy: '881337', text: '1F2937', soft: 'FFE4E6', border: 'FECDD3' }
    },
    forest: {
      id: 'forest',
      label: 'Forest',
      ...
      border: '#bbf7d0',
      canvasBg: '#f0fdf4',
      heroGrad: 'linear-gradient(145deg,#15803d 0%,#14532d 100%)',
      pptx: { accent: '16A34A', navy: '14532D', text: '14532D', soft: 'DCFCE7', border: 'BBF7D0' }
    },
  };
  ...
  function normalizeThemeId(value) {
    ...
    if (raw === 'mavi' || raw === 'blue' || raw === 'ocean') return 'ocean';
    if (raw === 'mor' || raw === 'purple' || raw === 'violet') return 'violet';
    if (raw === 'kirmizi' || raw === 'kırmızı' || raw === 'rose' || raw === 'red') return 'rose';
    if (raw === 'yesil' || raw === 'yeşil' || raw === 'green' || raw === 'forest') return 'forest';
  ...
  function ensurePicker() {
    ...
    wrap.innerHTML = `
      ...
      <button type="button" class="ap-theme-btn" data-theme="ocean">Ocean</button>
      <button type="button" class="ap-theme-btn" data-theme="violet">Violet</button>
      <button type="button" class="ap-theme-btn" data-theme="rose">Rose</button>
      <button type="button" class="ap-theme-btn" data-theme="forest">Forest</button>
    `;
