const TRANSLATIONS = {
  en: {
    ...
    "dash.nav.acadexsunum": "Acadex Presentation",
    ...
    "dash.presentation.emptyTitle": "No presentations yet",
    "dash.presentation.emptyDesc": "Create a new presentation to get started. You can build AI-assisted decks from a topic, Study Card, or document.",
    "dash.presentation.back": "List",
    "dash.presentation.aiAssist": "AI Assist",
    "dash.presentation.save": "Save",
    "dash.presentation.preview": "Preview",
    "dash.presentation.export": "PPTX / PDF",
    "dash.presentation.slides": "Slides",
    "dash.presentation.tools": "Content & Tools",
    "dash.presentation.layouts": "Layout",
    "dash.presentation.imageUpload": "Upload Image",
    "dash.presentation.uploadHint": "Click or drag",
    "dash.presentation.chooseFile": "Choose from computer",
    "dash.presentation.insert": "Quick Insert",
    "dash.presentation.insertTable": "Add Table",
    "dash.presentation.insertChart": "Add Chart",
    "dash.presentation.speakerNotes": "Speaker Notes",
    "dash.presentation.settings": "Presentation Settings",
    "dash.presentation.addSlide": "+ New Slide",
    "dash.presentation.complete": "Complete Presentation",
    ...
    "dash.cards.diagrams": "Diagrams",
    "dash.cards.examples": "Worked Examples",
    "dash.cards.executive": "30-Second Overview",
    "dash.cards.conceptGraph": "Concept Graph",
  ...
  tr: {
    ...
    "dash.nav.acadexsunum": "Acadex Sunum",
    ...
    "dash.presentation.emptyTitle": "Henüz sunumunuz yok",
    "dash.presentation.emptyDesc": "Yeni bir sunum oluşturarak başlayın. Konu, Study Card veya belge ile AI destekli sunum hazırlayabilirsiniz.",
    "dash.presentation.back": "Liste",
    "dash.presentation.aiAssist": "AI Asistan",
    "dash.presentation.save": "Kaydet",
    "dash.presentation.preview": "Önizle",
    "dash.presentation.export": "PPTX / PDF",
    "dash.presentation.slides": "Slaytlar",
    "dash.presentation.tools": "İçerik & Araçlar",
    "dash.presentation.layouts": "Düzen (Layout)",
    "dash.presentation.imageUpload": "Görsel Yükle",
    "dash.presentation.uploadHint": "Tıkla veya sürükle",
    "dash.presentation.chooseFile": "Bilgisayardan Seç",
    "dash.presentation.insert": "Hızlı Ekle",
    "dash.presentation.insertTable": "Tablo Ekle",
    "dash.presentation.insertChart": "Grafik Ekle",
    "dash.presentation.speakerNotes": "Konuşma Notları",
    "dash.presentation.settings": "Sunum Ayarları",
    "dash.presentation.addSlide": "+ Yeni Slayt",
    "dash.presentation.complete": "Sunumu Tamamla",
    ...
    "dash.cards.diagrams": "Diyagramlar",
    "dash.cards.examples": "Çözümlü Örnekler",
    "dash.cards.executive": "30 Saniyelik Özet",
    "dash.cards.conceptGraph": "Kavram Grafiği",
